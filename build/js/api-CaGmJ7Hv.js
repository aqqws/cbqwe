...
function n(e, t) {
    if (e.classList)
        ...
        let n = e.className.split(' ')
          , r = n.indexOf(t);
        r >= 0 ? n.splice(r, 1) : n.push(t),
        e.className = n.join(' ')
    }
}
function r(e, t, n) {
...
const h = u('string')
  ...
  , O = l('FileList')
  , S = l('URLSearchParams')
  , [T,A,v,x] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(l);
...
const N = 'undefined' != typeof globalThis ? globalThis : 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : global
  , P = e => !d(e) && e !== N;
const L = (_ = 'undefined' != typeof Uint8Array && i(Uint8Array),
e => _ && e instanceof _);
var _;
const U = l('HTMLFormElement')
  ...
  , I = {
    DIGIT: q,
    ALPHA: D,
    ALPHA_DIGIT: D + D.toUpperCase() + q
};
const M = l('AsyncFunction')
  , z = (H = 'function' == typeof setImmediate,
J = m(N.postMessage),
H ? setImmediate : J ? (W = `axios@${Math.random()}`,
K = [],
N.addEventListener('message', ( ({source: e, data: t}) => {
    e === N && t === W && K.length && K.shift()()
}
), !1),
e => {
    K.push(e),
...
var H, J, W, K;
const V = 'undefined' != typeof queueMicrotask ? queueMicrotask.bind(N) : 'undefined' != typeof process && process.nextTick || z;
var X = {
    isArray: f,
    isArrayBuffer: p,
    isBuffer: function(e) {
    ...
    merge: function e() {
        const {caseless: t} = P(this) && this || {}
          ...
          , r = (r, o) => {
            const s = t && C(n, o) || o;
            g(n[s]) && g(r) ? n[s] = e(n[s], r) : g(r) ? n[s] = e({}, r) : f(r) ? n[s] = r.slice() : n[s] = r
        }
        ;
        for (let e = 0, t = arguments.length; e < t; e++)
            arguments[e] && j(arguments[e], r);
        return n
    },
    extend: (e, t, n, {allOwnKeys: r}={}) => (j(t, ( (t, r) => {
...
const te = X.toFlatObject(X, {}, null, (function(e) {
...
function ne(e, t, n) {
    ...
    const r = (n = X.toFlatObject(n, {
      ...
      , s = n.dots
      , i = n.indexes
      , a = (n.Blob || 'undefined' != typeof Blob && Blob) && X.isSpecCompliantForm(t);
    if (!X.isFunction(o))
    ...
    function l(e, n, o) {
        ...
        if (e && !o && 'object' == typeof e)
            ...
            }(e) || (X.isFileList(e) || X.endsWith(n, '[]')) && (a = X.toArray(e)))
                return n = Y(n),
                a.forEach((function(e, r) {
                    !X.isUndefined(e) && null !== e && t.append(!0 === i ? ee([n], r, s) : null === i ? n : n + '[]', c(e))
                }
                )),
                !1;
        return !!Z(e) || (t.append(ee(o, n, s), c(e)),
        !1)
    }
    const u = []
      , f = Object.assign(te, {
    ...
    return function e(n, r) {
        if (!X.isUndefined(n)) {
            ...
            X.forEach(n, (function(n, s) {
                !0 === (!(X.isUndefined(n) || null === n) && o.call(t, n, X.isString(s) ? s.trim() : s, r, f)) && e(n, r ? r.concat(s) : [s])
            }
            )),
            u.pop()
        }
...
function ae(e, t, n) {
    ...
    let s;
    if (s = o ? o(t, n) : X.isURLSearchParams(t) ? t.toString() : new oe(t,n).toString(r),
    s) {
        const t = e.indexOf('#');
        -1 !== t && (e = e.slice(0, t)),
        e += (-1 === e.indexOf('?') ? '?' : '&') + s
...
function be(e) {
    function t(e, n, r, o) {
        ...
        const i = Number.isFinite(+s)
          , a = o >= e.length;
        if (s = !s && X.isArray(r) ? r.length : s,
        a)
            return X.hasOwnProp(r, s) ? r[s] = [r[s], n] : r[s] = n,
            !i;
    ...
    transformRequest: [function(e, t) {
        ...
        if (o) {
            if (n.indexOf('application/x-www-form-urlencoded') > -1)
                return function(e, t) {
                    return ne(e, new ye.classes.URLSearchParams, Object.assign({
                        visitor: function(e, t, n, r) {
                            return ye.isNode && X.isBuffer(e) ? (this.append(t, e.toString('base64')),
...
const we = X.toObjectSet(['age', 'authorization', 'content-length', 'content-type', 'etag', 'expires', 'from', 'host', 'if-modified-since', 'if-unmodified-since', 'last-modified', 'location', 'max-forwards', 'proxy-authorization', 'referer', 'retry-after', 'user-agent']);
const Ee = Symbol('internals');
function Re(e) {
    return e && String(e).trim().toLowerCase()
}
function Oe(e) {
    return !1 === e || null == e ? e : X.isArray(e) ? e.map(Oe) : String(e)
}
function Se(e, t, n, r, o) {
    return X.isFunction(r) ? r.call(this, t, n) : (o && (t = n),
    X.isString(t) ? X.isString(r) ? -1 !== t.indexOf(r) : X.isRegExp(r) ? r.test(t) : void 0 : void 0)
}
class Te {
    constructor(e) {
        e && this.set(e)
    ...
    set(e, t, n) {
        ...
        if (X.isPlainObject(e) || e instanceof this.constructor)
            s(e, t);
        else if (X.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim()))
            s((e => {
                const t = {};
                let n, r, o;
                return e && e.split('\n').forEach((e => {
    ...
    delete(e, t) {
        ...
        return X.isArray(e) ? e.forEach(o) : o(e),
        r
    }
    clear(e) {
    ...
    static accessor(e) {
        ...
        return X.isArray(e) ? e.forEach(r) : r(e),
        this
    }
}
function Ae(e, t) {
...
const Ce = (e, t, n=3) => {
  ...
  , Pe = e => (...t) => X.asap(( () => e(...t)));
var Le = ye.hasStandardBrowserEnv ? ( (e, t) => n => (n = new URL(n,ye.origin),
e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(new URL(ye.origin), ye.navigator && /(msie|trident)/i.test(ye.navigator.userAgent)) : () => !0
...
var ke = e => {
    ...
    if (ye.hasStandardBrowserEnv && (o && X.isFunction(o) && (o = o(t)),
    o || !1 !== o && Le(t.url))) {
        const e = s && i && _e.read(i);
        e && a.set(s, e)
    }
    return t
}
;
var De = 'undefined' != typeof XMLHttpRequest && (e => new Promise((function(t, n) {
    const r = ke(e);
    let o = r.data;
    const s = Te.from(r.headers).normalize();
    let i, a, c, l, u, {responseType: f, onUploadProgress: d, onDownloadProgress: p} = r;
    function h() {
        l && l(),
        u && u(),
    ...
    'setRequestHeader'in m && X.forEach(s.toJSON(), (function(e, t) {
        m.setRequestHeader(t, e)
    }
    )),
    X.isUndefined(r.withCredentials) || (m.withCredentials = !!r.withCredentials),
    ...
    b && -1 === ye.protocols.indexOf(b) ? n(new $('Unsupported protocol ' + b + ':',$.ERR_BAD_REQUEST,e)) : m.send(o || null)
}
)));
const qe = (e, t) => {
  ...
  , We = He && ('function' == typeof TextEncoder ? (Ke = new TextEncoder,
e => Ke.encode(e)) : async e => new Uint8Array(await new Response(e).arrayBuffer()));
var Ke;
const Ve = (e, ...t) => {
    try {
        return !!e(...t)
  ...
  , $e = Je && Ve(( () => X.isReadableStream(new Response('').body)))
  , Ge = {
    stream: $e && (e => e.body)
};
var Qe;
...
['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach((e => {
    !Ge[e] && (Ge[e] = X.isFunction(Qe[e]) ? t => t[e]() : (t, n) => {
...
const Ze = async (e, t) => {
    ...
    return n ?? (async e => {
        ...
        return X.isArrayBufferView(e) || X.isArrayBuffer(e) ? e.byteLength : (X.isURLSearchParams(e) && (e += ''),
        X.isString(e) ? (await We(e)).byteLength : void 0)
    }
    )(t)
}
;
const Ye = {
    ...
    xhr: De,
    fetch: He && (async e => {
        let {url: t, method: n, data: r, signal: o, cancelToken: s, timeout: i, onDownloadProgress: a, onUploadProgress: c, responseType: l, headers: u, withCredentials: f='same-origin', fetchOptions: d} = ke(e);
        l = l ? (l + '').toLowerCase() : 'text';
        let p, h = qe([o, s && s.toAbortSignal()], i);
        ...
        let y;
        try {
            if (c && Xe && 'get' !== n && 'head' !== n && 0 !== (y = await Ze(u, r))) {
                let e, n = new Request(t,{
                    method: 'POST',
                    body: r,
                    duplex: 'half'
                });
                if (X.isFormData(r) && (e = n.headers.get('content-type')) && u.setContentType(e),
                n.body) {
                    const [e,t] = Ne(y, Ce(Pe(c)));
            ...
            if ($e && (a || i && m)) {
                ...
                const t = X.toFiniteNumber(s.headers.get('content-length'))
                  , [n,r] = a && Ne(t, Ce(Pe(a), !0)) || [];
                s = new Response(ze(s.body, 65536, n, ( () => {
                    r && r(),
                    m && m()
                }
                )),e)
            ...
            l = l || 'text';
            let b = await Ge[X.findKey(Ge, l) || 'text'](s, e);
            return !i && m && m(),
...
var nt = e => {
    ...
    for (let s = 0; s < t; s++) {
        ...
        if (n = e[s],
        r = n,
        !tt(n) && (r = Ye[(t = String(n)).toLowerCase()],
        void 0 === r))
    ...
    if (!r) {
        ...
        throw new $('There is no suitable adapter to dispatch the request ' + (t ? e.length > 1 ? 'since :\n' + e.map(et).join('\n') : ' ' + et(e[0]) : 'as no adapter specified'),'ERR_NOT_SUPPORT')
    }
    return r
}
;
...
function ot(e) {
    ...
    return nt(e.adapter || ge.adapter)(e).then((function(t) {
        return rt(e),
...
it.transitional = function(e, t, n) {
    return (r, o, s) => {
        if (!1 === e)
            throw new $(function(e, t) {
                return '[Axios v1.7.9] Transitional option \'' + e + '\'' + t + (n ? '. ' + n : '')
            }(o, ' has been removed' + (t ? ' in ' + t : '')),$.ERR_DEPRECATED);
        return t && !at[o] && (at[o] = !0),
        !e || e(r, o, s)
    }
}
,
        ...
        for (; o-- > 0; ) {
            ...
            if (i) {
                const t = e[s]
                  , n = void 0 === t || i(t, s, e);
                if (!0 !== n)
                    throw new $('option ' + s + ' must be ' + n,$.ERR_BAD_OPTION_VALUE)
            } else if (!0 !== n)
...
class ut {
    ...
    _request(e, t) {
        ...
        null != r && (X.isFunction(r) ? t.paramsSerializer = {
            serialize: r
        } : ct.assertOptions(r, {
            encode: lt.function,
        ...
        let s = o && X.merge(o.common, o[t.method]);
    ...
    getUri(e) {
        return ae(Ue((e = Be(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer)
    }
}
...
const pt = function e(t) {
    const n = new ut(t)
      , r = o(ut.prototype.request, n);
    return X.extend(r, ut.prototype, n, {
        allOwnKeys: !0
    }),
    X.extend(r, n, null, {
        allOwnKeys: !0
...
pt.mergeConfig = Be,
pt.AxiosHeaders = Te,
pt.formToJSON = e => be(X.isHTMLForm(e) ? new FormData(e) : e),
pt.getAdapter = nt,
...
const ht = pt.create()
  , mt = (e, t, n) => {
    ...
    ht(r).then((e => Promise.resolve(e.data))).catch((e => Promise.reject(e)))
}
  , yt = {
    get: (e, t) => mt('GET', e, t),
    post: (e, t) => mt('POST', e, t),
    put: (e, t) => mt('PUT', e, t),
    patch: (e, t) => mt('PATCH', e, t)
};
export {yt as A, e as a, r as f, t as r, n as t};
