...
const l = i('string')
  ...
  , g = s('FileList')
  , w = s('URLSearchParams')
  , [E,R,O,S] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(s);
...
const v = 'undefined' != typeof globalThis ? globalThis : 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : global
  , x = e => !c(e) && e !== v;
const C = (j = 'undefined' != typeof Uint8Array && n(Uint8Array),
e => j && e instanceof j);
var j;
...
const D = s('AsyncFunction')
  , k = (q = 'function' == typeof setImmediate,
I = f(v.postMessage),
q ? setImmediate : I ? (M = `axios@${Math.random()}`,
z = [],
v.addEventListener('message', ( ({source: e, data: t}) => {
    e === v && t === M && z.length && z.shift()()
}
), !1),
e => {
    z.push(e),
...
var q, I, M, z;
const H = 'undefined' != typeof queueMicrotask ? queueMicrotask.bind(v) : 'undefined' != typeof process && process.nextTick || k;
var J = {
    isArray: a,
    isArrayBuffer: u,
    isBuffer: function(e) {
    ...
    extend: (t, n, r, {allOwnKeys: o}={}) => (T(n, ( (n, o) => {
...
const Q = J.toFlatObject(J, {}, null, (function(e) {
...
function Z(e, t, n) {
    ...
    const r = (n = J.toFlatObject(n, {
      ...
      , s = n.dots
      , i = n.indexes
      , a = (n.Blob || 'undefined' != typeof Blob && Blob) && J.isSpecCompliantForm(t);
    if (!J.isFunction(o))
    ...
    function c(e) {
        ...
        return J.isArrayBuffer(e) || J.isTypedArray(e) ? a && 'function' == typeof Blob ? new Blob([e]) : Buffer.from(e) : e
    }
    function u(e, n, o) {
        let a = e;
        if (e && !o && 'object' == typeof e)
            ...
            }(e) || (J.isFileList(e) || J.endsWith(n, '[]')) && (a = J.toArray(e)))
                return n = G(n),
                a.forEach((function(e, r) {
                    !J.isUndefined(e) && null !== e && t.append(!0 === i ? X([n], r, s) : null === i ? n : n + '[]', c(e))
                }
                )),
                !1;
        return !!$(e) || (t.append(X(o, n, s), c(e)),
        !1)
    }
    const l = []
      , f = Object.assign(Q, {
    ...
    return function e(n, r) {
        if (!J.isUndefined(n)) {
            ...
            J.forEach(n, (function(n, s) {
                !0 === (!(J.isUndefined(n) || null === n) && o.call(t, n, J.isString(s) ? s.trim() : s, r, f)) && e(n, r ? r.concat(s) : [s])
            }
            )),
            l.pop()
        }
...
function re(e, t, n) {
    ...
    const r = n && n.encode || ne
      , o = n && n.serialize;
    let s;
    if (s = o ? o(t, n) : J.isURLSearchParams(t) ? t.toString() : new ee(t,n).toString(r),
    s) {
        const t = e.indexOf('#');
        -1 !== t && (e = e.slice(0, t)),
        e += (-1 === e.indexOf('?') ? '?' : '&') + s
...
const ae = 'undefined' != typeof window && 'undefined' != typeof document
  , ce = 'object' == typeof navigator && navigator || void 0
  , ue = ae && (!ce || ['ReactNative', 'NativeScript', 'NS'].indexOf(ce.product) < 0)
  , le = 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && 'function' == typeof self.importScripts
  , fe = ae && window.location.href || 'http://localhost';
var de = {
    ...Object.freeze({
        __proto__: null,
        hasBrowserEnv: ae,
...
function he(e) {
    function t(e, n, r, o) {
        ...
        const i = Number.isFinite(+s)
          , a = o >= e.length;
        if (s = !s && J.isArray(r) ? r.length : s,
        a)
            return J.hasOwnProp(r, s) ? r[s] = [r[s], n] : r[s] = n,
            !i;
        r[s] && J.isObject(r[s]) || (r[s] = []);
        return t(e, n, r[s], o) && J.isArray(r[s]) && (r[s] = function(e) {
            const t = {}
              , n = Object.keys(e);
            let r;
            const o = n.length;
    ...
    transformRequest: [function(e, t) {
        ...
        if (o) {
            if (n.indexOf('application/x-www-form-urlencoded') > -1)
                return function(e, t) {
                    return Z(e, new de.classes.URLSearchParams, Object.assign({
                        visitor: function(e, t, n, r) {
                            return de.isNode && J.isBuffer(e) ? (this.append(t, e.toString('base64')),
...
var me = pe;
const ye = J.toObjectSet(['age', 'authorization', 'content-length', 'content-type', 'etag', 'expires', 'from', 'host', 'if-modified-since', 'if-unmodified-since', 'last-modified', 'location', 'max-forwards', 'proxy-authorization', 'referer', 'retry-after', 'user-agent']);
const be = Symbol('internals');
function ge(e) {
    return e && String(e).trim().toLowerCase()
}
function we(e) {
    return !1 === e || null == e ? e : J.isArray(e) ? e.map(we) : String(e)
}
function Ee(e, t, n, r, o) {
    return J.isFunction(r) ? r.call(this, t, n) : (o && (t = n),
...
class Re {
    ...
    set(e, t, n) {
        ...
        function o(e, t, n) {
            ...
            (!s || void 0 === r[s] || !0 === n || void 0 === n && !1 !== r[s]) && (r[s || t] = we(e))
        }
        ...
        if (J.isPlainObject(e) || e instanceof this.constructor)
            ...
            s((e => {
                ...
                return e && e.split('\n').forEach((e => {
                    ...
                    !n || t[n] && ye[n] || ('set-cookie' === n ? t[n] ? t[n].push(r) : t[n] = [r] : t[n] = t[n] ? t[n] + ', ' + r : r)
                }
                )),
                t
            }
    ...
    delete(e, t) {
        ...
        function o(e) {
            if (e = ge(e)) {
                ...
                !o || t && !Ee(0, n[o], o, t) || (delete n[o],
                r = !0)
            }
        }
        return J.isArray(e) ? e.forEach(o) : o(e),
        r
    }
    clear(e) {
        ...
        for (; n--; ) {
            const o = t[n];
            e && !Ee(0, this[o], o, e, !0) || (delete this[o],
            r = !0)
        }
        return r
    }
...
J.reduceDescriptors(Re.prototype, ( ({value: e}, t) => {
...
const xe = (e, t, n=3) => {
  ...
  , je = e => (...t) => J.asap(( () => e(...t)));
var Pe = de.hasStandardBrowserEnv ? function() {
    const e = de.navigator && /(msie|trident)/i.test(de.navigator.userAgent)
...
var Ue = e => {
    const t = Fe({}, e);
    let n, {data: r, withXSRFToken: o, xsrfHeaderName: s, xsrfCookieName: i, headers: a, auth: c} = t;
    if (t.headers = a = Oe.from(a),
    t.url = re(_e(t.baseURL, t.url), e.params, e.paramsSerializer),
    ...
    if (de.hasStandardBrowserEnv && (o && J.isFunction(o) && (o = o(t)),
    o || !1 !== o && Pe(t.url))) {
...
;
var Be = 'undefined' != typeof XMLHttpRequest && (e => new Promise((function(t, n) {
    const r = Ue(e);
    let o = r.data;
    const s = Oe.from(r.headers).normalize();
    let i, a, c, u, l, {responseType: f, onUploadProgress: d, onDownloadProgress: h} = r;
    function p() {
        u && u(),
        l && l(),
    ...
    function y() {
        if (!m)
            return;
        const r = Oe.from('getAllResponseHeaders'in m && m.getAllResponseHeaders());
        ve((function(e) {
            t(e),
            p()
        }
    ...
    ,
    m.onabort = function() {
        m && (n(new W('Request aborted',W.ECONNABORTED,e,m)),
        m = null)
    }
    ,
    m.onerror = function() {
        n(new W('Network Error',W.ERR_NETWORK,e,m)),
        m = null
    }
    ,
    m.ontimeout = function() {
        let t = r.timeout ? 'timeout of ' + r.timeout + 'ms exceeded' : 'timeout exceeded';
        const o = r.transitional || se;
        r.timeoutErrorMessage && (t = r.timeoutErrorMessage),
        n(new W(t,o.clarifyTimeoutError ? W.ETIMEDOUT : W.ECONNABORTED,e,m)),
        m = null
    }
    ,
    void 0 === o && s.setContentType(null),
    'setRequestHeader'in m && J.forEach(s.toJSON(), (function(e, t) {
    ...
    b && -1 === de.protocols.indexOf(b) ? n(new W('Unsupported protocol ' + b + ':',W.ERR_BAD_REQUEST,e)) : m.send(o || null)
}
)));
var De = (e, t) => {
    ...
    if (t || n) {
        ...
        const o = function(e) {
            if (!n) {
                ...
                r.abort(t instanceof W ? t : new Ae(t instanceof Error ? t.message : t))
            }
        };
        let s = t && setTimeout(( () => {
            s = null,
...
const ke = function*(e, t) {
  ...
  , ze = Me && 'function' == typeof ReadableStream
  , He = Me && ('function' == typeof TextEncoder ? (Je = new TextEncoder,
e => Je.encode(e)) : async e => new Uint8Array(await new Response(e).arrayBuffer()));
var Je;
const We = (e, ...t) => {
    try {
        return !!e(...t)
  ...
  , Ve = ze && We(( () => J.isReadableStream(new Response('').body)))
  , $e = {
    stream: Ve && (e => e.body)
};
var Ge;
...
['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach((e => {
    !$e[e] && ($e[e] = J.isFunction(Ge[e]) ? t => t[e]() : (t, n) => {
...
const Xe = async (e, t) => {
    ...
    return n ?? (async e => {
        ...
        J.isString(e) ? (await He(e)).byteLength : void 0)
    }
    )(t)
}
;
const Qe = {
    ...
    xhr: Be,
    fetch: Me && (async e => {
        let {url: t, method: n, data: r, signal: o, cancelToken: s, timeout: i, onDownloadProgress: a, onUploadProgress: c, responseType: u, headers: l, withCredentials: f='same-origin', fetchOptions: d} = Ue(e);
        u = u ? (u + '').toLowerCase() : 'text';
        let h, p = De([o, s && s.toAbortSignal()], i);
        ...
        let y;
        try {
            if (c && Ke && 'get' !== n && 'head' !== n && 0 !== (y = await Xe(l, r))) {
                let e, n = new Request(t,{
                    method: 'POST',
                    body: r,
                    duplex: 'half'
                });
                if (J.isFormData(r) && (e = n.headers.get('content-type')) && l.setContentType(e),
                n.body) {
                    const [e,t] = Ce(y, xe(je(c)));
                    r = Ie(n.body, 65536, e, t)
                }
            }
            ...
            let s = await fetch(h);
            const i = Ve && ('stream' === u || 'response' === u);
            if (Ve && (a || i && m)) {
                const e = {};
                ...
                const t = J.toFiniteNumber(s.headers.get('content-length'))
                  , [n,r] = a && Ce(t, xe(je(a), !0)) || [];
                s = new Response(Ie(s.body, 65536, n, ( () => {
                    r && r(),
                    m && m()
                }
                )),e)
            ...
            u = u || 'text';
            let b = await $e[J.findKey($e, u) || 'text'](s, e);
            return !i && m && m(),
            ...
            t && 'TypeError' === t.name && /fetch/i.test(t.message))
                throw Object.assign(new W('Network Error',W.ERR_NETWORK,e,h), {
                    cause: t.cause || t
                });
            throw W.from(t, t && t.code, e, h)
        }
    }
    )
};
...
const Ze = e => `- ${e}`
  , Ye = e => J.isFunction(e) || null === e || !1 === e;
var et = e => {
    e = J.isArray(e) ? e : [e];
    const {length: t} = e;
    let n, r;
    ...
    for (let s = 0; s < t; s++) {
        ...
        if (n = e[s],
        r = n,
        !Ye(n) && (r = Qe[(t = String(n)).toLowerCase()],
        void 0 === r))
            throw new W(`Unknown adapter '${t}'`);
        if (r)
            break;
        o[t || '#' + s] = r
    }
    if (!r) {
        ...
        throw new W('There is no suitable adapter to dispatch the request ' + (t ? e.length > 1 ? 'since :\n' + e.map(Ze).join('\n') : ' ' + Ze(e[0]) : 'as no adapter specified'),'ERR_NOT_SUPPORT')
    }
    return r
}
;
...
function nt(e) {
    ...
    return et(e.adapter || me.adapter)(e).then((function(t) {
        ...
        return Te(t) || (tt(e),
        t && t.response && (t.response.data = Se.call(e, e.transformResponse, t.response),
...
ot.transitional = function(e, t, n) {
    return (r, o, s) => {
        if (!1 === e)
            throw new W(function(e, t) {
                return '[Axios v1.7.7] Transitional option \'' + e + '\'' + t + (n ? '. ' + n : '')
            }(o, ' has been removed' + (t ? ' in ' + t : '')),W.ERR_DEPRECATED);
        ...
        for (; o-- > 0; ) {
            ...
            if (i) {
                const t = e[s]
                  , n = void 0 === t || i(t, s, e);
                if (!0 !== n)
                    throw new W('option ' + s + ' must be ' + n,W.ERR_BAD_OPTION_VALUE)
            } else if (!0 !== n)
...
class ct {
    ...
    getUri(e) {
        return re(_e((e = Fe(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer)
    }
}
...
class lt {
    constructor(e) {
        ...
        ,
        e((function(e, r, o) {
            n.reason || (n.reason = new Ae(e,r,o),
            t(n.reason))
        }
        ))
    }
...
const pt = function t(n) {
    const r = new ut(n)
      , o = e(ut.prototype.request, r);
    return J.extend(o, ut.prototype, r, {
        allOwnKeys: !0
    }),
    J.extend(o, r, null, {
        allOwnKeys: !0
...
pt.mergeConfig = Fe,
pt.AxiosHeaders = Oe,
pt.formToJSON = e => he(J.isHTMLForm(e) ? new FormData(e) : e),
pt.getAdapter = et,
...
const mt = pt.create()
  , yt = (e, t, n) => {
    ...
    return r['GET' === e ? 'params' : 'data'] = n,
    mt(r).then((e => Promise.resolve(e.data))).catch((e => Promise.reject(e)))
}
  , bt = {
    get: (e, t) => yt('GET', e, t),
    post: (e, t) => yt('POST', e, t),
    put: (e, t) => yt('PUT', e, t),
    patch: (e, t) => yt('PATCH', e, t)
};
export {bt as A};
